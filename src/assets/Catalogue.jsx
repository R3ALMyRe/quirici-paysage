      ...
      {selectedProduit && (
        ...
        >
          <div className="relative w-full max-w-[900px]">
            ...
            <button
              onClick={closeModal}
              className="absolute top-5 right-5 text-gray-700 hover:text-white text-5xl font-bebas z-20"
            >
              ×
            </button>

            <div
              className="bg-white/90 w-full max-h-[90vh] relative flex flex-col md:flex-row shadow-lg overflow-y-auto rounded"
