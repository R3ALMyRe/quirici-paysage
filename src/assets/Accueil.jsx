    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          height: "calc(100vh - 78px)", // 78px = hauteur de ta navbar
        }}
      >
        {/* Titre en haut */}
      ...
      {/* Services (cards cliquables -> pages correspondantes) */}
    ...
    {servicesSections.map(({ key, title, text, bgImage }) => {
      ...
      return (
        <div
          ...
          className="relative flex flex-col justify-end transition-all duration-500 ease-in-out select-none"
          style={{
        ...
        >
          ...
          >
            ...
            <p className="text-white font-light max-w-[260px] mb-5 text-sm sm:text-base">
              {text}
            </p>
            ...
            <Link to={`/${key}`}>
              <img
                ...
                alt={`Voir ${title}`}
                className="hidden md:inline cursor-pointer w-7 hover:scale-110 transition-transform duration-300"
              />
            </Link>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-8 py-8 flex flex-col md:flex-row gap-12">
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          ...
          <Link
            to="/contact"
            className="bg-[#315747] text-white py-3.5 px-8 rounded-none hover:bg-[#264736] transition w-max font-semibold select-none"
          >
            Contactez-nous
          </Link>
        </div>
      ...
      <section className="mt-30 max-w-7xl mx-auto px-8 py-16 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="md:w-1/2 text-left">
          ...
          <Link
            to="/ventes"
            className="mt-8 bg-[#315747] hover:bg-[#264736] text-white font-semibold py-3.5 px-8 rounded-none select-none transition inline-block"
          >
            En savoir plus
          </Link>
        </div>
